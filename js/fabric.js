  ...
  initMousedownHandler: function() {
    this.on('mousedown', function(options) {
      ...
      if (this.hiddenTextarea && this.canvas) {
        ...
        //this.canvas.wrapperEl.insertBefore(this.hiddenTextarea, this.canvas.wrapperEl.firstChild);
      }
...
fabric.util.object.extend(fabric.IText.prototype, /** @lends fabric.IText.prototype */ {
  ...
  initHiddenTextarea: function() {
    ...
    this.hiddenTextarea.style.cssText = 'font-size: 50px; position: absolute; top: '+this.top+'px; left: 0; opacity: 0;';
                                       // + ' z-index: -999;';

    fabric.document.body.appendChild(this.hiddenTextarea);
    //fabric.document.body.insertBefore(this.hiddenTextarea, fabric.document.body.firstChild);
